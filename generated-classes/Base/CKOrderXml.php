...
/**
 * Base class that represents a row from the 'cklien_order_xml' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class CKOrderXml implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CKOrderXmlTableMap';
    ...
    /**
     * The value for the order_xml field.
     *
     * @var        string
     */
    protected $order_xml;
    ...
    /**
     * Initializes internal state of Base\CKOrderXml object.
     */
    ...
    /**
     * Compares this with another <code>CKOrderXml</code> instance.  If
     * <code>obj</code> is an instance of <code>CKOrderXml</code>, delegates to
     * <code>equals(CKOrderXml)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CKOrderXml The current object, for fluid interface
     */
    ...
    /**
     * Get the [order_xml] column value.
     *
     * @return string
     */
    public function getOrderXml()
    {
        return $this->order_xml;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CKOrderXmlTableMap::COL_ID] = true;
        }
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[CKOrderXmlTableMap::COL_ORDER_ID] = true;
        }
    ...
    /**
     * Set the value of [order_xml] column.
     *
     * @param string $v new value
     * @return $this|\CKOrderXml The current object (for fluent API support)
     */
    public function setOrderXml($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->order_xml !== $v) {
            $this->order_xml = $v;
            $this->modifiedColumns[CKOrderXmlTableMap::COL_ORDER_XML] = true;
        }
    ...
    public function setOrderDate($v)
    {
        ...
        if ($this->order_date !== null || $dt !== null) {
            if ($this->order_date === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->order_date->format("Y-m-d H:i:s")) {
                $this->order_date = $dt === null ? null : clone $dt;
                $this->modifiedColumns[CKOrderXmlTableMap::COL_ORDER_DATE] = true;
            }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CKOrderXmlTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CKOrderXmlTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CKOrderXmlTableMap::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CKOrderXmlTableMap::translateFieldName('OrderXml', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_xml = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CKOrderXmlTableMap::translateFieldName('OrderDate', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCKOrderXmlQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CKOrderXml::setDeleted()
     * @see CKOrderXml::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCKOrderXmlQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CKOrderXmlTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CKOrderXmlTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CKOrderXmlTableMap::COL_ORDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'order_id';
        }
        if ($this->isColumnModified(CKOrderXmlTableMap::COL_ORDER_XML)) {
            $modifiedColumns[':p' . $index++]  = 'order_xml';
        }
        ...
        $sql = sprintf(
            'INSERT INTO cklien_order_xml (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'order_id':
                        ...
                        break;
                    case 'order_xml':
                        $stmt->bindValue($identifier, $this->order_xml, PDO::PARAM_STR);
                        break;
                    case 'order_date':
    ...
    {
        $pos = CKOrderXmlTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CKOrderXml'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CKOrderXml'][$this->hashCode()] = true;
        $keys = CKOrderXmlTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CKOrderXmlTableMap::COL_ID)) {
            $criteria->add(CKOrderXmlTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CKOrderXmlTableMap::COL_ORDER_ID)) {
            $criteria->add(CKOrderXmlTableMap::COL_ORDER_ID, $this->order_id);
        }
        if ($this->isColumnModified(CKOrderXmlTableMap::COL_ORDER_XML)) {
            $criteria->add(CKOrderXmlTableMap::COL_ORDER_XML, $this->order_xml);
        }
        if ($this->isColumnModified(CKOrderXmlTableMap::COL_ORDER_DATE)) {
    ...
    {
        $criteria = ChildCKOrderXmlQuery::create();
        $criteria->add(CKOrderXmlTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CKOrderXml (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CKOrderXml Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CKOrderXmlTableMap::DEFAULT_STRING_FORMAT);
    }
